  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-blue-500 to-blue-600 p-1">
          <div className="rounded-3xl bg-white p-8 text-center dark:bg-gray-900">
            <h3 className="mb-3 text-2xl font-bold text-gray-900 md:text-3xl dark:text-white">
